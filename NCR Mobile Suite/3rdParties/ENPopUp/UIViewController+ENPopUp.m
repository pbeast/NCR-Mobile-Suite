...
//    UIImageView *bluredView = [[UIImageView alloc] initWithFrame:overlayView.bounds];
//    bluredView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
//    bluredView.tag = kENPopUpBluredViewTag;
//    bluredView.backgroundColor = [UIColor greenColor];
//    
//    UIImage* bluredBack = [self blurWithCoreImage:[self takeSnapshotOfView:sourceView]];
//    [bluredView setImage:bluredBack];
//    
